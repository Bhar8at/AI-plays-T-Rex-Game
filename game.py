...
class DinoGame:
    ...
    def load_sprites(self):
        ...
        self.player = pygame.image.load('images/Dino.bmp').convert()
        self.player_runnning = pygame.image.load('images/Dino_Running.png').convert()
        ...
        self.cactus = pygame.image.load('images/Cactus.png').convert()
    ...
    def play_step(self, action):
        ...
        if len(self.cactii_list) < self.cactii_limit and time.time() - self.cactus_time > random.choice(self.cactus_intervals):
            self.cactii_list.append(Cactus(self.cactus_pos.x, self.cactus_pos.y))
            self.cactus_time = time.time()
